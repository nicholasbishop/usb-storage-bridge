...
// This file contains the USB enumeration descriptors for a Keyboard and a
// routine that sets them The keyboard supports Boot protocol = 8 byte Interrupt
// In packets and 1 byte Set Feature Out packets Note that there are alignment
// requirements for descriptors This uses my VID = 0x4242 - use is permitted for
// development but NOT as a product
//
