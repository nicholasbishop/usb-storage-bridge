 ...
 */
uint16_t CyFxGpifTransition[] = {0x0000, 0x8080, 0x2222, 0x5555,
                                 0x7F7F, 0x1F1F, 0x8888};
...
/* Summary
   ...
   waveform table.
 */
CyU3PGpifWaveData CyFxGpifWavedata[] = {{{0x1E086001, 0x000302C4, 0x80000000},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x4E080302, 0x00000300, 0x80000000},
                                         {0x1E086006, 0x000302C4, 0x80000000}},
                                        {{0x1E086001, 0x000302C4, 0x80000000},
                                         {0x4E040704, 0x00000300, 0xC0000100}},
                                        {{0x4E080302, 0x00000300, 0x80000000},
                                         {0x1E086001, 0x000302C4, 0x80000000}},
                                        {{0x00000000, 0x00000000, 0x00000000},
                                         {0x00000000, 0x00000000, 0x00000000}},
                                        {{0x00000000, 0x00000000, 0x00000000},
                                         {0x3E738705, 0x00000300, 0xC0100000}},
                                        {{0x00000000, 0x00000000, 0x00000000},
                                         {0x5E002703, 0x2003030C, 0x80000000}},
                                        {{0x00000000, 0x00000000, 0x00000000},
                                         {0x4E040704, 0x00000300, 0xC0000100}}};
...
uint8_t CyFxGpifWavedataPosition[] = {
    0, 1, 0, 2, 0, 0, 3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 0, 5, 0, 2, 0, 0, 5, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 0, 6, 0, 2, 0, 0, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 0, 7, 0, 2, 0, 0, 7};
